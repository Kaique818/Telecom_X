...
- Falta de serviços adicionais aumenta o risco de cancelamento  
- Pagamento via **Electronic Check** apresenta maior taxa de churn  

---

## 📌 Conclusão
A evasão de clientes na Telecom X está fortemente relacionada a fatores **contratuais, financeiros e de experiência do usuário**.  
Os resultados podem ser utilizados como base para **estratégias de retenção** e **modelos preditivos de churn**.
...
Interesse em Análise de Dados, Data Science e Tecnologia  
